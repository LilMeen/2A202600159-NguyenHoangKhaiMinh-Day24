...
class TestPIIDetection:
    ...
    def test_cccd_detected(self, anonymizer):
        ...
        assert len(results) > 0, "No entities detected"
...
class TestAnonymization:
    ...
    def test_pii_not_in_output(self, anonymizer, sample_df):
        ...
        for original_cccd in sample_df["cccd"]:
            ...
            assert str(original_cccd) not in df_anon["cccd"].values, f"Original CCCD {original_cccd} found in anonymized data"
    ...
    def test_non_pii_columns_unchanged(self, anonymizer, sample_df):
        ...
        assert df_anon["benh"].equals(sample_df["benh"]), "Column 'benh' has been modified"
        assert df_anon["ket_qua_xet_nghiem"].equals(sample_df["ket_qua_xet_nghiem"]), "Column 'ket_qua_xet_nghiem' has been modified"
